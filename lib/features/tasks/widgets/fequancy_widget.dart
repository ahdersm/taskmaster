...
typedef FrequencyEntry = DropdownMenuEntry<FrequencyLabel>;
...
enum FrequencyLabel {
  ...
  static final List<FrequencyEntry> entries = UnmodifiableListView<FrequencyEntry>(
    values.map<FrequencyEntry>(
      (FrequencyLabel frequency) => FrequencyEntry(
        value: frequency,
...
class FrequancySelector extends StatefulWidget{
  const FrequancySelector({
    super.key,
  ...
  @override
  State<FrequancySelector> createState() => _FrequancySelector();
}

class _FrequancySelector extends State<FrequancySelector>{

  @override
  Widget build(BuildContext context) {
    return DropdownMenu<FrequencyLabel>(
      initialSelection: FrequencyLabel.daily,
      dropdownMenuEntries: FrequencyLabel.entries,
